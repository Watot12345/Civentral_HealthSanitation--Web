...
class Database
{
    ...
    public function query(
        ...
        $skipCache = in_array($table, ['system_settings', 'settings', 'setting_categories', 'feature_flags', 'settings_versions', 'audit_logs', 'system_logs', 'scheduler_logs', 'ai_analytics_logs', 'employees', 'roles', 'role_permissions', 'user_sessions']);
