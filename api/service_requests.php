...
try {
    ...
    switch ($method) {
        ...
        case 'PATCH':
            if ($id) {
                ...
                Response::error('Service request ID is required for update', 400);
            }
            break;
        ...
        case 'DELETE':
            if ($id) {
                ...
                Response::error('Service request ID is required for deletion', 400);
            }
            break;
    ...
    error_log('API Error in service_requests.php: ' . $e->getMessage());
